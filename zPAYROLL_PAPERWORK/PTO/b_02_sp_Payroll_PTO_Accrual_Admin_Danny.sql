...
/****** Object:  StoredProcedure [dbo].[sp_Payroll_PTO_Accrual_Admin_Danny]    Script Date: 1/22/2024 9:08:04 AM ******/
--DROP PROCEDURE [dbo].[sp_Payroll_PTO_Accrual_Admin_Danny]
--GO
...
--CREATE PROCEDURE [dbo].[sp_Payroll_PTO_Accrual_Admin_Danny]
--(

--@PayPeriodEndDate Date
--,@LastUpdateBy Int

-- exec sp_Payroll_PTO_Accrual_Admin_Danny '12/16/2023', 2775
...
--DANNY ADDED STUFF
--select * from [RedBone].[main].[Person]
--where personid in
--(
--SELECT PersonId
