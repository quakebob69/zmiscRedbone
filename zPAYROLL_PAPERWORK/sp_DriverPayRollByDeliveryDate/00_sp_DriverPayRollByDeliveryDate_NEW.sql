...
/****** Object:  StoredProcedure [dbo].[sp_DriverPayRollByDeliveryDate_NEW]    Script Date: 1/12/2024 8:45:38 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER procedure [dbo].[sp_DriverPayRollByDeliveryDate_NEW]
(
        @StartDt datetime 
        ,@ThroughDt datetime 
...
exec sp_DriverPayRollByDeliveryDate_NEW '05/01/2021', '05/10/2021'
