...
/****** Object:  StoredProcedure [dbo].[00_sp_DriverPayRollByDeliveryDate_Pay_NEW]    Script Date: 1/15/2024 9:06:21 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[00_sp_DriverPayRollByDeliveryDate_Pay_NEW]
(
        @StartDt datetime 
        ,@ThroughDt datetime 
)
...
exec 00_sp_DriverPayRollByDeliveryDate_Pay_NEW '10/31/2021', '11/06/2021'
