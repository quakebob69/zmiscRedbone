...
/****** Object:  StoredProcedure [dbo].[sp_DriverPayRollByDeliveryDate_Pay_DANNY]    Script Date: 1/18/2024 7:34:45 AM ******/
DROP PROCEDURE [dbo].[sp_DriverPayRollByDeliveryDate_Pay_DANNY]
GO
...
CREATE procedure [dbo].[sp_DriverPayRollByDeliveryDate_Pay_DANNY]
(
        @StartDt datetime 
        ,@ThroughDt datetime 
)
...
exec sp_DriverPayRollByDeliveryDate_Pay_DANNY '10/31/2021', '11/06/2021'
