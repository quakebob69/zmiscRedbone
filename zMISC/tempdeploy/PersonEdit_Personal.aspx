    ...
    <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
            ...
            function pageLoad() {
                ...
                $telerik.$('.ruFileInput').attr('accept', '.jpg,.jpeg,.gif,.pdf');
            ...
            function enableCertUpdateButton() {
                // Find all buttons with the specific ID pattern
                var buttons = document.querySelectorAll('[id$="_btnCertUpdate"]');
            ...
            function disableCertUpdateButton() {
                // Find all buttons with the specific ID pattern
                var buttons = document.querySelectorAll('[id$="_btnCertUpdate"]');
            ...
            function onClientFileSelected(sender, args) {
                ...
                var allowedTypes = ["application/pdf", "image/jpeg", "image/png"]; // Add or modify allowed types as needed
                ...
                if (file && allowedTypes.indexOf(file.type) === -1) {
                    ...
                    args.get_fileInputField().value = '';
                    disableCertUpdateButton();
                } else {
                    enableCertUpdateButton();
                }
            }

            // Function to find and initialize the RadAsyncUpload control
            function initializeAsyncUpload() {
                var uploadElements = document.getElementsByClassName('my-async-upload');
                if (uploadElements.length > 0) {
                    var asyncUpload = $find(uploadElements[0].id);
                    if (asyncUpload) {
                        // Set the OnClientFileSelected event handler
                        asyncUpload.add_fileSelected(onFileSelected);
                    }
                }
            }
            ...
            if (window.addEventListener) {
                window.addEventListener('load', initializeAsyncUpload, false);
            } else if (window.attachEvent) {
                window.attachEvent('onload', initializeAsyncUpload);
            }
            ...
            function RadGrid_OnCertificationsGridCreated(sender, args) {
                ...
                try {
                    if (gridCertifications.get_masterTableView().get_editItems().length > 0 || gridCertifications.get_masterTableView().get_insertItem() != undefined) {
                        if (gridCertifications.get_masterTableView().get_editItems().length > 0) {
                            enableCertUpdateButton();
                        }
            ...
            function onRequestStartPersonPersonal(sender, args) {
                if (args.get_eventTarget().indexOf("DownloadCertButton") >= 0) {
...
<body style="margin: 0px;">
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" ClientEvents-OnRequestStart="onRequestStartPersonPersonal">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="RadAsyncUploadCert">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="RadAsyncUploadCert" />
                        <telerik:AjaxUpdatedControl ControlID="FileNameLbl" />
                    </UpdatedControls>
                </telerik:AjaxSetting>

                <telerik:AjaxSetting AjaxControlID="FileNameLbl">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="RadAsyncUploadCert" />
                        <telerik:AjaxUpdatedControl ControlID="FileNameLbl" />
                    </UpdatedControls>
                ...
                <telerik:AjaxSetting AjaxControlID="RadButton_Save_Top">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="RadButton_Save_Top" LoadingPanelID="RadAjaxLoadingPanel1" UpdatePanelCssClass="" />
                        <telerik:AjaxUpdatedControl ControlID="Label_UpdateSuccess_Top" />
                        <telerik:AjaxUpdatedControl ControlID="Label_UpdateSuccess" />
                        <telerik:AjaxUpdatedControl ControlID="CustomValidator_Name_Top" UpdatePanelCssClass="" />
                ...
                <telerik:AjaxSetting AjaxControlID="Label_UpdateSuccess">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="Label_UpdateSuccess_Top" UpdatePanelCssClass="" />
                    </UpdatedControls>
                </telerik:AjaxSetting>

                <telerik:AjaxSetting AjaxControlID="Label_UpdateSuccess_Top">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="Label_UpdateSuccess" UpdatePanelCssClass="" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <tr>
                    <td style="padding-top: 20px;">
                        <table style="border-width: 0px; padding: 0px; margin: 0px">
                            <tr>
                                <td>
                                    <telerik:RadButton ID="RadButton_Save_Top" runat="server" Text="Save Personal Info" OnClick="RadButton_Save_Click" Width="150px"></telerik:RadButton>
                                </td>
                                <td style="padding-left: 10px">
                                    <asp:Label ID="Label_UpdateSuccess_Top" runat="server" Text="Personal Info Saved!" Visible="false"></asp:Label>
                                    <asp:CustomValidator ID="CustomValidator_Name_Top" runat="server" ForeColor="Red" Display="Dynamic"
                            ...
                            <table style="border-width: 0px; padding: 0px; margin: 0px">
                                <tr>
                                    ...
                                    <td style="padding-left: 15px">
                                        ...
                                        <telerik:RadTextBox ID="RadTextBox_MiddleInitial" runat="server" EmptyMessage="M.I." Width="25px" MaxLength="1" />
                        ...
                        <div>
                            <fieldset>
                                ...
                                <telerik:RadGrid ID="RadGrid_Certifications" runat="server" CellSpacing="-1" AllowAutomaticDeletes="True"
                                    ...
                                    OnItemCommand="RadGrid_Certifications_ItemCommand"
                                    ...
                                    <MasterTableView GridLines="None"
                                        ...
                                        DataKeyNames="CertificationPersonMappingId,CertificationTypeId" EditMode="PopUp">
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 70px; text-align: right;">
                                                        <telerik:RadCheckBox ID="RadCheckBox_ShowInactive" Text="Show Inactive" runat="server" OnClick="RadCheckBox_ShowInactive_Click"></telerik:RadCheckBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </CommandItemTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="CertificationPersonMappingId" DataType="System.Int32"
                                                FilterControlAltText="Filter CertificationPersonMappingId column" HeaderText="CertificationPersonMappingId"
                                                SortExpression="CertificationPersonMappingId" UniqueName="CertificationPersonMappingId" Visible="false" ReadOnly="true">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="CertificationDescription" FilterControlAltText="Filter CertificationDescription column"
                                                HeaderText="Type" SortExpression="CertificationDescription" UniqueName="CertificationDescription" ColumnEditorID="GridTextBoxColumnEditor_Generic">
                                            ...
                                            <telerik:GridTemplateColumn AllowFiltering="false" UniqueName="downldBtn">
                                                <ItemTemplate>
                                                    <telerik:RadButton ID="DownloadCertButton" runat="server" Text="Download" UniqueName="DownloadCertButton" CommandName="downld" CommandArgument='<%# Eval("FileName") %>' />
                                                </ItemTemplate>
                                                <HeaderStyle Width="40px" />
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridButtonColumn ConfirmText="Are you sure you want to delete this Certification?" FooterStyle-HorizontalAlign="Right"
                                                CommandName="Delete" Text="Delete" ConfirmDialogType="RadWindow" UniqueName="Dlt" ConfirmTitle="Delete Certification?"
                                        ...
                                        <EditFormSettings EditFormType="Template">
                                            <PopUpSettings Width="580px" Height="450px" KeepInScreenBounds="True" />
                                            <EditColumn UniqueName="EditCommandColumn1" FilterControlAltText="Filter EditCommandColumn1 column">
                                            </EditColumn>
                                            <FormTemplate>
                                                <div style="margin: 5px; padding: 5px; width: 550px">
                                                                ...
                                                                <td>
                                                                    <table style="border-style: none; border-width: thin; border-color: inherit; padding-top: 5px">
                                                                        <tr>
                                                                            ...
                                                                            <td class="auto-style2">
                                                                                <telerik:RadDropDownList ID="RadDropDownList_CertificationTypes" runat="server"
                                                                                    ...
                                                                                    SelectedValue='<%# Bind("CertificationTypeId") %>' Width="180px" Enabled="false">
                                                                                </telerik:RadDropDownList>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="auto-style2">
                                                                                <telerik:RadTextBox ID="RadTextBox_CertifiationNotes" runat="server" Width="400px" LabelWidth="40%"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="auto-style2">
                                                                                <telerik:RadCheckBox Checked='<%# Bind("ActiveInd") %>' ID="RadCheckBox_Active" runat="server" AutoPostBack="False" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="auto-style1" style="padding-top: 25px;">Certification File</td>
                                                                            <td class="auto-style2" style="padding-top: 25px;">
                                                                                <telerik:RadAsyncUpload RenderMode="Lightweight" runat="server" ID="RadAsyncUploadCert" AllowedFileExtensions="jpg,jpeg,gif,pdf" MaxFileInputsCount="1" OnClientFileSelected="onClientFileSelected" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="auto-style1">&nbsp;</td>
                                                                            <td class="auto-style2">
                                                                                <telerik:RadLabel ID="FileNameLbl_Lbl" runat="server" Text="Current File:  " Visible="false" />
                                                                                <telerik:RadLabel ID="FileNameOnlyLbl" runat="server" Visible="false" />
                                                                                <telerik:RadLabel ID="FileNameLbl" runat="server" Text='<%# Bind("FileName")%>' Style="font-weight: bold;" Visible="false" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="auto-style4" colspan="2" style="padding-top: 20px; padding-bottom: 0px">
                                                                                <asp:Button ID="btnCertUpdate" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>' runat="server" CommandName='<%# (Container is GridEditFormInsertItem) ? "PerformInsert" : "Update" %>' Enabled="false" />&nbsp;
                                                                                <asp:Button ID="btnCertCancel" Text="Cancel" runat="server" CausesValidation="False" CommandName="Cancel" />
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                ...
                                <td width="33%" style="vertical-align: top;">
                                    <fieldset>
                                        ...
                                        <telerik:RadListBox ID="RadListBox_PersonTypes" runat="server" CheckBoxes="True" Width="100%"
                                            Height="450px" OnClientItemChecked="RadControl_OnValueChanged">
                                        </telerik:RadListBox>
                                    </fieldset>
                                </td>
                                <td width="33%" style="vertical-align: top;">
                ...
                <tr>
                    <td style="padding-bottom: 20px;">
                        <table style="border-width: 0px; padding: 0px; margin: 0px">
                            <tr>
                                <td>
                                    <telerik:RadButton ID="RadButton_Save" runat="server" Text="Save Personal Info" OnClick="RadButton_Save_Click" Width="150px"></telerik:RadButton>
                                </td>
                                <td style="padding-left: 10px">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource_PhoneNumberType" runat="server"
            OldValuesParameterFormatString="original_{0}" SelectMethod="GetData"
            TypeName="RedbonePlatform.Datasets.dsPersonAddressContactTableAdapters.PhoneNumberTypeTableAdapter"></asp:ObjectDataSource>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource_CellCarriers" runat="server"
            OldValuesParameterFormatString="original_{0}" SelectMethod="GetData"
            TypeName="RedbonePlatform.Datasets.dsPersonAddressContactTableAdapters.CellCarrierTableAdapter"></asp:ObjectDataSource>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource_HomeTerminal" runat="server"
            ...
            FilterExpression="Enabled=1"></asp:ObjectDataSource>
    </form>
</body>
</html>
