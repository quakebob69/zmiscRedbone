...
<head runat="server">
    ...
    <style>
        ...
        .RadDropDownListDefault .rddlInner {
        }
        .rddlDefaultMessage {
		...
		.ediBoxLocked, .ediBoxLocked a, .ediBoxUnLocked, .ediBoxUnLocked a {
		...
		.ediBoxUnLocked::before {
			content: "";
			background-image: url("../../images/unlock-solid.png");
			background-repeat: no-repeat;
			background-position: left center;
			background-size: cover;
			position: relative;
		...
		.lockButton {
			...
			background: url(../images/lock-solid.png)!important;
		}
    </style>
...
<body style="height: 100%; margin: 0px;">
    <form id="form1" runat="server" style="height: 100%; margin: 0px">
            ...
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="RadAjaxManager1">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="spanEdiLoad" />
                ...
                <telerik:AjaxSetting AjaxControlID="RadButton_Leg">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="HiddenField_StopToLoadNextOnPostback" UpdatePanelCssClass="" />
                        <telerik:AjaxUpdatedControl ControlID="RadButton_Leg" UpdatePanelCssClass="" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="RadDockLayout1" UpdatePanelCssClass="" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <%--<telerik:AjaxSetting AjaxControlID="RadButton_Empty">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="HiddenField_StopToLoadNextOnPostback"
                            UpdatePanelCssClass="" />
                        <telerik:AjaxUpdatedControl ControlID="RadButton_Empty" UpdatePanelCssClass=""
                ...
                <telerik:AjaxSetting AjaxControlID="RadButton_FuelStop">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="HiddenField_StopToLoadNextOnPostback" UpdatePanelCssClass="" />
                        <telerik:AjaxUpdatedControl ControlID="RadButton_FuelStop" UpdatePanelCssClass="" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="spanEdiLoad" />
                        <telerik:AjaxUpdatedControl ControlID="RadDockLayout1" UpdatePanelCssClass="" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="RadNumericTextBox_LoadedMiles">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="RadNumericTextBox_BillableMiles" />
                        <telerik:AjaxUpdatedControl ControlID="Label_GrossRevenue" />
                        <telerik:AjaxUpdatedControl ControlID="Label_RPM1" />
                        <telerik:AjaxUpdatedControl ControlID="Label_ACCBillable" />
                        <telerik:AjaxUpdatedControl ControlID="Label_Rate" />
                ...
                <telerik:AjaxSetting AjaxControlID="RadNumericTextBox_BillableMiles">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="RadNumericTextBox_LoadedMiles" />
                        <telerik:AjaxUpdatedControl ControlID="RadNumericTextBox_PaidLoaded" />
                        <telerik:AjaxUpdatedControl ControlID="RadNumericTextBox_BillableMiles" />
                ...
                <telerik:AjaxSetting AjaxControlID="RadComboBox_Customer">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="Label_CustomerAddressContact" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="Label_GrossRevenue" />
                        <telerik:AjaxUpdatedControl ControlID="Label_RPM1" />
                ...
                <telerik:AjaxSetting AjaxControlID="RadComboBox_Status">
                    <UpdatedControls>
                        ...
                        <%--<telerik:AjaxUpdatedControl ControlID="RadButton_Empty" />--%>
        ...
        <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" MinDisplayTime="250" Modal="true" />
                                ...
                                <table>
                                    ...
                                    <tr>
										<td style="padding-top: 10px; padding-left: 5px" colspan="2">
											<table id="tblAddStops" border="0">
                                                <tr>
													<td width="80px" style="font-size: 14px;">
														<asp:Label ID="lblCounter" runat="server"></asp:Label>
                                                        <telerik:RadButton ID="RadButton_Pick" runat="server" Text="Pick" Font-Bold="true" Enabled="false" OnClick="RadButton_Pick_Click" TabIndex="0">
                                                            <Icon PrimaryIconUrl="../../images/16x16/Add_16x.png" PrimaryHoveredIconUrl="../../images/16x16/Add_inverse_16x.png" />
                                                        </telerik:RadButton>
                                                    </td>
													<td width="80px" style="font-size: 14px;">
                                                        <telerik:RadButton ID="RadButton_Drop" runat="server" Text="Drop" Font-Bold="true" Enabled="false" OnClick="RadButton_Drop_Click" TabIndex="1">
                                                            <Icon PrimaryIconUrl="../../images/16x16/Add_16x.png" PrimaryHoveredIconUrl="../../images/16x16/Add_inverse_16x.png" />
                                                        </telerik:RadButton>
                                                    </td>
													<td width="80px" style="font-size: 14px;">
													...
													<%--<td width="90px" style="font-size: 14px;">
                                                        <telerik:RadButton ID="RadButton_Empty" runat="server" Text="Empty" Font-Bold="true" OnClick="RadButton_Empty_Click" TabIndex="4">
                                                            <Icon PrimaryIconUrl="../../images/16x16/Add_16x.png" PrimaryHoveredIconUrl="../../images/16x16/Add_inverse_16x.png" />
                                                        </telerik:RadButton>
                                                    </td>--%>
													<td width="80px" style="font-size: 14px;">
                                                        <telerik:RadButton ID="RadButton_FuelStop" runat="server" Text="Fuel" Font-Bold="true" OnClick="RadButton_FuelStop_Click" TabIndex="5">
                                                            <Icon PrimaryIconUrl="../../images/16x16/Add_16x.png" PrimaryHoveredIconUrl="../../images/16x16/Add_inverse_16x.png" />
                                                        </telerik:RadButton>
                                                    </td>
													<td style="font-size: 14px;">
														<span id="spanEdiLoad" runat="server"></span>
													</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5">
											...
											<td style="text-align: center;">
												<table style="width: 100%;">
		                                            ...
		                                            <tr>
														...
														<td style="text-align: left">Billable</td>
													</tr>
													<tr>
														<td style="text-align: left;">Miles:</td>
														<td style="padding: 0;">
															<telerik:RadNumericTextBox ID="RadNumericTextBox_EmptyMiles" runat="server" Width="50px" Culture="en-US" DbValueFactor="1"
														...
														<td class="nospacing">
															<telerik:RadNumericTextBox ID="RadNumericTextBox_LoadedMiles" runat="server" Width="50px" AutoPostBack="True"
														...
														<td class="nospacing">
															<telerik:RadNumericTextBox ID="RadNumericTextBox_BillableMiles" runat="server" Width="50px" AutoPostBack="True"
																Culture="en-US" DbValueFactor="1" MaxValue="10000" MinValue="0" TabIndex="11" ReadOnly="False"
																OnTextChanged="RadNumericTextBox_BillableMiles_TextChanged">
																<NegativeStyle Resize="None"></NegativeStyle>
																<NumberFormat ZeroPattern="n" DecimalDigits="0"></NumberFormat>
																<EmptyMessageStyle Resize="None"></EmptyMessageStyle>
																<ReadOnlyStyle Resize="None"></ReadOnlyStyle>
													...
													<tr>
														<td colspan="2" style="padding-top:7px;" class="DispatchSheetCol1-style">Gross Revenue:</td>
														<td colspan="2" style="text-align: left;padding-top:7px;">
															<asp:Label ID="Label_GrossRevenue" runat="server" ToolTip="Gross Revenue = (ACC Revenue Charges + Flat Rate)"></asp:Label>
														</td>
													</tr>
													<tr>
														<td colspan="2" class="DispatchSheetCol1-style">RPM:</td>
													...
													<tr>
														<td colspan="4" class="DispatchSheetCol1-style" colspan="2">
    ...
    <telerik:RadScriptBlock ID="RadScriptBlock2" runat="server">
        <script type="text/javascript">
			...
			function RadComboBox_Status_SelectedIndexChanging(sender, args) {
				...
				if (cmboSub != null && ToBeSelectedValue != "6" && ToBeSelectedValue != "9") {
...
<%--            function CustomValidator_TempEquipment_ClientValidate(src, args) {
			...
			function ShowEdiAlert() {
				Alert('Adding drops to an EDI enabled load is not permitted.');
			}

			function EdiLock() {
				$find("<%= RadAjaxManager.GetCurrent(Page).ClientID %>").ajaxRequest('EdiLock');
			}
