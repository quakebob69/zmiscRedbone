...
--ADJUST RECORDS
		...
		-------------------------------------------------------------------------------------------------------------------------------------------------
																					...
																					--------------------------------------------------------------------------------------------------------------
																						--IN
																							--DECLARE @EntryId__IN INTEGER = 29943
																							--DECLARE @Clocked__IN NVARCHAR(25)		= '2024-09-10 06:17:45.633';
																						...
																						--OUT
																							--DECLARE @EntryId__OUT INTEGER = 29904
																							--DECLARE @Clocked__OUT NVARCHAR(25)		= '2024-09-09 15:53:00.837'
