/****** Object:  StoredProcedure [payroll].[sp_Payroll_OTR_FinalizePayRecords__Load]    Script Date: 2/14/2024 11:23:30 AM ******/
...
CREATE procedure [payroll].[sp_Payroll_OTR_FinalizePayRecords__Load]
(
...
/*
	exec [payroll].[sp_Payroll_OTR_FinalizePayRecords__Load] '2350', 2775
*/
...
--vars
	...
	DECLARE @DataSourceName_LOAD NVARCHAR(4)
