...
--REDBONE COMPANY
	--EARNINGS
		...
		INSERT INTO [export].[AccountingExportPayrollItem] ([AccountingExportCompanyId], [AccountingExportPayrollEntryTypeId], [NameQB], [NameLegacy], [Order], [Enabled]) VALUES (1, 1, 'Drop & Hook (Doubles)', 'asdf', 2, 1);
