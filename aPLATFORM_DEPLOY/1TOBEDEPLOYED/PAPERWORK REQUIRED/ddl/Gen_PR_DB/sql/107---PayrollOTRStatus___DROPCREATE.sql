...
INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [ShortDescription], [UserStepsJson]) VALUES (4, 'VALIDATION_FAILED', 4, 'Validation Failed', '["OTR payroll failed the validation step.", "1) Manually make the necessary corrections in QuickBooks.", "2) Click ''Submit For Validation''."]');
INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [ShortDescription], [UserStepsJson]) VALUES (5, 'VALIDATION_PASSED', 5, 'Validation Passed', '["OTR payroll has been successfully validated is ready to be finalized. This pay period will be closed and the next one will be initialzed.", "1. Click ''Finalize the Pay Period''"]');
