...
INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [Description], [HasUserAction], [UserAction], [UseForPayrollProcess]) VALUES (2, 'STAGING', 2, 'OTR payroll data is being corrected and staged.', 1, 'Stage, review and correct bad or missing data in ''Trucking Loads'' and ''Driver Pay''.  Re-stage and review after making corrections.', 1);
