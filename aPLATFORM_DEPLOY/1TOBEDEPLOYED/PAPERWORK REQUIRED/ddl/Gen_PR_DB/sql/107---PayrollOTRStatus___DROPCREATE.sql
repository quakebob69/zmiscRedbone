...
INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [ShortDescription], [Description], [UserStepsJson], [UseForPayrollProcess]) VALUES (6, 'FINALIZED', 6, 'Finalized', 'OTR payroll has been finalized.', '["Upload EFS LLC and Quick Q files.1", "Click the Import button to import the data into the Redbone Platform database. Note: Files will be deleted after they have been successfully imported.2"]', 1);
