...
INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [ShortDescription], [UserStepsJson], [UseForPayrollProcess]) VALUES (2, 'STAGING', 2, 'Staging', '["1) Get (or refresh) payroll data.", "2) Generate ''QuickBooks Data Entry'' file by clicking on the green ''qb'' button.", "3)  If needed, correct ''Driver Pay'' data and/or ''Load'' data, and repeat steps 1 and 2."]', 1);
*/INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [ShortDescription], [UserStepsJson], [UseForPayrollProcess]) VALUES (1, 'STAGED', 3, 'Staged', '["OTR payroll has been staged and is ready to be entered into QuickBooks.", "1) Generate the ''QuickBooks Data Entry'' file by clicking on the green ''qb'' button.", "2) Manually enter the data into QuickBooks.", "3) Click ''Submit'' to submit the pay period for validation."]', 1);
...
INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [ShortDescription], [UserStepsJson], [UseForPayrollProcess]) VALUES (5, 'VALIDATION_FAILED', 5, 'Validation Failed', '["OTR payroll failed validation.", "1) Manually make the necessary corrections in QuickBooks.", "2) Click ''Submit'' to submit the pay period for validation."]', 1);
