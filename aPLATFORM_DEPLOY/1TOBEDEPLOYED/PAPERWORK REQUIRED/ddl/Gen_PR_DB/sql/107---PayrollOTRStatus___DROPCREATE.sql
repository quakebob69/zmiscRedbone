...
INSERT INTO [payroll].[PayrollOTRStatus] ([PayrollOTRStatusId], [Name], [Order], [ShortDescription], [UserStepsJson]) VALUES (4, 'VALIDATION_FAILED', 5, 'Validation Failed', '["OTR payroll failed the validation. step", "1) Manually make the necessary corrections in QuickBooks.", "2) Click ''Submit For Validation''.","NOTE:  If ''Driver Pay'' and/or ''Load'' data need to be updated, click ''RESET THE PAY PERIOD''."]');
