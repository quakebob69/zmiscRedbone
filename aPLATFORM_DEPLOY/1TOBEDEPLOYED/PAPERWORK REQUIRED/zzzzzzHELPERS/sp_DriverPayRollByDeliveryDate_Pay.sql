...
/****** Object:  StoredProcedure [payroll].[sp_DriverPayRollByDeliveryDate_Pay]    Script Date: 2/2/2024 11:36:52 AM ******/
DROP PROCEDURE [payroll].[sp_DriverPayRollByDeliveryDate_Pay]
GO
...
CREATE procedure [payroll].[sp_DriverPayRollByDeliveryDate_Pay]
(
        @StartDt datetime 
        ,@ThroughDt datetime 
)
...
exec sp_DriverPayRollByDeliveryDate_Pay '10/31/2021', '11/06/2021'
